...
public class HelloController implements Initializable {
    ...
    @FXML public void comprasTiempo() throws Exception {
        ComprasAplication.getInstance().invocarPantalla(); //00133723 Activa la pantalla de la aplicacion
    }

    @FXML public void tarjetasAsociados() throws Exception
    {
        TarjetasClienteAplication.getInstance().invocarPantalla(); //00133723 Activa la pantalla de la aplicacion
    }

    @FXML public void dineroPorMes () throws Exception
    {
        DineroMesAplication.getInstance().invocarPantalla();//00133723 Activa la pantalla de la aplicacion
    }

    @FXML public void ClienteAsociadoFacilitador() throws Exception
    {
        TarjetasFacilitadorAplication.getInstance().invocarPantalla();//00133723 Activa la pantalla de la aplicacion
    }
